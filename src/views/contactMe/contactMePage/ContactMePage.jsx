...
function ContactMePage() {
  return (
    <div className='contact-me-page db-page-padding-2'>
      <div className='db-color-gold mb-5 fs-2 fw-bold'>Contact Me</div>
      <p className='fs-4'>
        If you have any project which is vanilla JS, React JS or Next JS, you
        can contact me by phone or email or even my linked account. My telegram
        and whatsapp account is on this phone number.
      </p>
      <p className='fs-4'>
      ...
      <p className='fs-4 mb-5'>
        ...
        <br></br>
        Or if you have seen the code in my github account, and have good tips to
        give me, I would appreciate it.
        <br></br>
